...
function App() {
  ...
  useEffect(() => {
    const handleEnvUpdate = (params: Omit<EnvironmentParameters, "masterGain">) => {
      setEnvParams(prev => ({
        ...prev,
        ...params,
      }));
  ...
  return (
    <div className="app">
        ...
        <div className="env-display">
          ...
          <div className="env-grid">
            <div className="env-param">
              ...
              <span className="env-value">{Math.round(envParams.light * 100)}%</span>
            </div>
            ...
            <div className="env-param">
              ...
              <span className="env-value">{Math.round(envParams.wind * 100)}%</span>
            </div>
            ...
            <div className="env-param">
              ...
              <span className="env-value">{Math.round(envParams.humidity * 100)}%</span>
            </div>
            ...
            <div className="env-param">
              ...
              <span className="env-value">{Math.round(envParams.temperature * 100)}%</span>
            </div>
          </div>
          <p className="env-note">
            <small>Environment parameters evolve automatically via simulation worker</small>
          </p>
        </div>
      </main>
      ...
      <footer className="app-footer">
        <small>
          Powered by Web Audio API • Real-time synthesis • No samples • Mobile optimized
        </small>
      </footer>
    </div>
  );
